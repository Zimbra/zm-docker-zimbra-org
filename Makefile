...
build-zmc-%: build-zmc-base docker-compose_lonni.yml
	@echo "-----------------------------------------------------------------"
	@echo Building zmc-$*
	@echo
	...
	DOCKER_REPO_NS=${DOCKER_REPO_NS} \
	    ...
	    docker-compose -f docker-compose_lonni.yml build 'zmc-$*'
	@echo "-----------------------------------------------------------------"
...
.up.lock: init-configs init-passwords init-keys docker-compose_lonni.yml
